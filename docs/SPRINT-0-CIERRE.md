...
| 2026-07-13 | En el contrato productivo, `bultos` y `peso_bruto` son enteros y el punto visible en TICA separa miles. | Decision de M1: `3.000` debe publicarse como `3000`. |
